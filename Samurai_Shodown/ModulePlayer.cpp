...
ModulePlayer::ModulePlayer()
{
	//animations
	{
		...
		//win animation
		{
			...
			win.PushBack({802, 2353, 98, 209}, 0.15f);
			win.PushBack({908, 2353, 98, 209}, 0.15f);
			win.PushBack({1024, 2353, 74, 209}, 0.15f);
			win.PushBack({1123, 2353, 74, 209}, 0.15f);
			win.PushBack({1213, 2353, 76, 209}, 0.15f);
			win.PushBack({1302, 2353, 83, 209}, 0.15f);
			win.PushBack({1405, 2353, 100, 209}, 0.15f);
			win.PushBack({1521, 2353, 100, 209}, 0.15f);
			win.PushBack({1635, 2353, 89, 209}, 0.15f);
			win.PushBack({1751, 2353, 89, 209}, 0.15f);
			win.PushBack({1862, 2353, 72, 209}, 0.15f);
			win.PushBack({71, 2588, 72, 190}, 0.15f);
			win.PushBack({180, 2598, 72, 180}, 0.15f);
			win.PushBack({277, 2603, 72, 175}, 0.15f);
			win.PushBack({380, 2613, 72, 165}, 0.15f);
			win.PushBack({476, 2621, 72, 157}, 0.15f);
			win.PushBack({577, 2630, 72, 148}, 0.15f);
			win.PushBack({670, 2666, 72, 112}, 0.15f);
			win.PushBack({765, 2666, 72, 112}, 0.15f);
