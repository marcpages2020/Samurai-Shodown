...
update_status ModuleCharacterSelection::Update() {
	...
	if ((App->input->keyboard[SDL_SCANCODE_F3] == KEY_DOWN) || (App->input->keyboard[SDL_SCANCODE_C] == KEY_DOWN)|| (App->input->keyboard[SDL_SCANCODE_H] == KEY_DOWN) || (SDL_GetTicks()>20000))
	{
